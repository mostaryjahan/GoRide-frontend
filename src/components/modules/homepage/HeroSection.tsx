        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
          ...
          <div className="w-1/2">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-lg">
              Your reliable ride is just a tap away. Experience premium comfort, safety, and convenience with our professional drivers.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10 mb-10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium">Safe rides</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="bg-blue-100 p-2 rounded-full">
                  <Car className="h-5 w-5 text-blue-600" />
                </div>
                <span className="text-gray-700 dark:text-gray-300 font-medium">Premium vehicles</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="bg-blue-100 p-2 rounded-full">
                  <Star className="h-5 w-5 text-blue-600" />
                </div>
                <span className="text-gray-700 dark:text-gray-300 font-medium">Rated drivers</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-1/2 flex-1 flex justify-center">
            <div className="relative">
                    ...
                    <div className="bg-white rounded-2xl p-4 text-gray-800 mt-8">
                      <div className="flex justify-between mb-4">
                        <div>
                          ...
                          <div className="text-sm text-gray-500">4 min away • SUV</div>
                        </div>
                      ...
                      <div className="flex justify-between">
                        <div>
                          ...
                          <div className="text-sm text-gray-500">7 min away • Premium</div>
                        </div>
              ...
              <div className="absolute -top-6 -right-6 bg-white shadow-lg rounded-2xl p-4 w-48">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                    <Star className="h-6 w-6 text-blue-600" />
                  </div>
                  <div>
                    <div className="font-bold dark:text-gray-500">4.9/5</div>
